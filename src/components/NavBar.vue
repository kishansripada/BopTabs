    ...
    <div class="container-fluid">
          ...
          <defs>
            <clipPath id="clip-path" transform="translate(-5.68 -6.81)">
              <rect
                width="54.59"
                height="32.91"
                transform="translate(54.59 32.91) rotate(180)"
                style="fill: none"
              />
            </clipPath>
            <clipPath id="clip-path-2" transform="translate(-5.68 -6.81)">
              <polyline
                points="19.34 31 150.83 31 150.83 102.06 19.34 102.06"
                style="fill: none"
              />
            </clipPath>
          </defs>
          <g id="Layer_2" data-name="Layer 2">
            <g id="Layer_1-2" data-name="Layer 1">
              ...
              <g style="clip-path: url(#clip-path-2)">
                <path
                  d="M25.83,72.34c.14-2.31.28-5.74.28-8.75v-41H32.2V43.92h.14c2.17-3.78,6.09-6.23,11.55-6.23,8.4,0,14.35,7,14.28,17.29,0,12.11-7.63,18.13-15.19,18.13-4.9,0-8.82-1.89-11.34-6.37h-.21l-.28,5.6ZM32.2,58.76A11.53,11.53,0,0,0,32.48,61a9.5,9.5,0,0,0,9.24,7.21C48.16,68.21,52,63,52,55.19c0-6.79-3.5-12.6-10.08-12.6a9.82,9.82,0,0,0-9.38,7.56,12.14,12.14,0,0,0-.35,2.52Z"
                  transform="translate(-5.68 -6.81)"
                  style="fill: #231f20"
                />
                <path
                  d="M96.6,55.12c0,12.53-8.68,18-16.87,18-9.17,0-16.24-6.72-16.24-17.43,0-11.34,7.42-18,16.8-18C90,37.69,96.6,44.76,96.6,55.12Zm-26.88.35c0,7.42,4.27,13,10.29,13S90.3,63,90.3,55.33c0-5.74-2.87-13-10.15-13S69.72,49,69.72,55.47Z"
                  transform="translate(-5.68 -6.81)"
                  style="fill: #231f20"
                />
                <path
                  d="M104.37,49.52c0-4.34-.14-7.84-.28-11.06h5.53l.28,5.81H110a13.32,13.32,0,0,1,12-6.58c8.19,0,14.35,6.93,14.35,17.22,0,12.18-7.42,18.2-15.4,18.2-4.48,0-8.4-2-10.43-5.32h-.14V86.2h-6.09Zm6.09,9a13.87,13.87,0,0,0,.28,2.52A9.5,9.5,0,0,0,120,68.28c6.51,0,10.29-5.32,10.29-13.09,0-6.79-3.57-12.6-10.08-12.6a9.83,9.83,0,0,0-9.31,7.63,10,10,0,0,0-.42,2.52Z"
                  transform="translate(-5.68 -6.81)"
                  style="fill: #231f20"
                />
              </g>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#"
              ><router-link to="/track/284fVGdbsPtigjjI0jmKXo/tabs"
                >About</router-link
              ></a
            >
          </li>
          <!-- <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#"
              ><router-link to="/add">Add</router-link></a
            >
          </li> -->
        </ul>
